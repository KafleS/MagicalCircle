...
public class ok extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        overlayPane.getChildren().add(pointsNeeded);
        overlayPane.getChildren().add(multiNeeded);
        overlayPane.getChildren().add(playButton);
        overlayPane.getChildren().add(pauseButton);
        overlayPane.getChildren().add(colorChangingSpeed);
        overlayPane.getChildren().add(fpsSlider);
        overlayPane.getChildren().add(incrementNeeded);
        overlayPane.getChildren().addAll(startbutton,stopbutton);
        overlayPane.getChildren().add(label);
        overlayPane.getChildren().add(label1);
        overlayPane.getChildren().add(label2);
        overlayPane.getChildren().add(label3);
        overlayPane.getChildren().add(label4);
        overlayPane.getChildren().add(label5);
